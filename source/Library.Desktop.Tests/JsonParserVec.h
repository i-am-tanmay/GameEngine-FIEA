...
{
	class JsonParserVec final : public FIEAGameEngine::IJsonParser
	{
		RTTI_DECLARATIONS(JsonParserVec);
	...
	public:
		...
		public:
			...
			/// </summary>
			FIEAGameEngine::Vector<glm::vec4> Data;
		...
		/// <summary>
		/// Parse Vec4 data corresponding to previous Start Handler call
		/// </summary>
		/// <param name="sharedData">Reference to shared data to parse into</param>
		/// <param name="key">Reference to key of json pair</param>
	...
	private:
		inline static const std::string VecKey{ "vec4" };
